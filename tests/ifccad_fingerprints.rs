use acadifc::ifccad::canonicalization::{fingerprint, fingerprint_typed_value, CanonicalValue};
use acadifc::ifccad::conformance::{bundled_conformance_root, verify_fingerprint_vectors};
use serde_json::json;
